...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Tiles Survive best heroes",
    "Tiles Survive troop composition",
    "Tiles Survive factions",
    "Tiles Survive reforge",
    "Tiles Survive Behemoth",
    "Tiles Survive events",
    "Tiles Survive Arcadian Conquest",
    "4X strategy",
    "FunPlus",
    "war room",
