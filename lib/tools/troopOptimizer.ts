...
> = {
  guards: {
    lead: {
      ...
      why: "Soaks the opening blow and holds the wall while your counter-squad grinds.",
    },
    support: {
      name: "Lucky",
      portrait: "/heroes/lucky.webp",
      role: "Sustain",
      why: "Keeps the frontline standing through prolonged pushes.",
    },
    note: "Guard-led marches win by outlasting — pair with healers, extend the fight.",
  },
  gunners: {
    lead: {
      name: "Ghost",
      ...
      role: "Tempo Engine",
      why: "Cooldown reduction keeps midline gun damage rolling without gaps.",
    },
    support: {
      name: "Lucky",
      portrait: "/heroes/lucky.webp",
      role: "Sustain",
      why: "Covers the fragile midline while Gunners melt their Guards.",
    },
    note: "Gunner marches need tempo — stack cooldown/skill-cycle support.",
  },
  marksmen: {
    lead: {
      name: "Maddie",
      ...
      role: "Burst Carry",
      why: "Backline deletion — the consensus carry when Marksmen rule the meta.",
    },
    support: {
      name: "Ghost",
      portrait: "/heroes/ghost.webp",
      role: "Tempo",
      why: "Faster skill cycles mean more burst windows per fight.",
    },
    note: "Marksman-heavy marches are glass cannons — burst first, ask later.",
  },
};
