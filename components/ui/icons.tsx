...
/* ------------------------------------------------------------------ */
/*  Hand-rolled 24px stroke icon set (lucide-style, zero deps).        */
/*  Keeps the client bundle lean — no icon-library runtime.            */
/* ------------------------------------------------------------------ */
...
export const CrosshairIcon = (p: IconProps) => (
  <svg {...base(p)}>
    ...
    <line x1="21" x2="17" y1="12" y2="12" />
    <line x1="7" x2="3" y1="12" y2="12" />
    <line x1="12" x2="12" y1="21" y2="17" />
...
export const AnvilIcon = (p: IconProps) => (
  <svg {...base(p)}>
    <path d="M4 21v-2" />
    <path d="M9 21H4" />
    <path d="M2.5 9.5 4 8h6l3 3h4.5a4.5 4.5 0 0 0 0-9H4L2.5 3.5" />
    <path d="m12 11 3 3h6.5l-2 5H8l-3-3z" />
  </svg>
);
...
/** Icon registry keyed by name — used by data-driven sections. */
export const icons = {
  swords: SwordsIcon,
