...
/* ------------------------------------------------------------------ */
/*  CommandRings — two tilted orbit rings circling the monolith,       */
/*  like a targeting reticle over the war map.                         */
/* ------------------------------------------------------------------ */
  ...
  return (
    <group position={[0, 0.9, 0]}>
      <mesh ref={r1} rotation={[1.15, 0.3, 0]}>
        ...
        <meshBasicMaterial color="#f5b942" transparent opacity={0.55} />
      </mesh>
      <mesh ref={r2} rotation={[1.35, -0.4, 0]}>
        <torusGeometry args={[3.5, 0.02, 8, 96]} />
        <meshBasicMaterial color="#ff5c33" transparent opacity={0.28} />
      </mesh>
    </group>
  );
}
